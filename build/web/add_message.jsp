    ...
    <body>
        <div>
            <form name="add_message_form" method="post" action="db_insert.jsp">
                Please fill <B><U>ALL</U></B> the fields below to add a new splash screen message:
                <br><br>
                ...
                Message Contents: <input type="text" id="content" name="content" size="80" onBlur="validateFormFields('add_message_form', 'add_message_form_submit');"><br>
